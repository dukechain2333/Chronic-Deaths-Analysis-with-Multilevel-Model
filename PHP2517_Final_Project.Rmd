...
In this section, we will use the `glmer` function to fit a multilevel model to the data. We add the random effect on `State` level to the model. 
...
We will use AIC to compare the models to determine the best model.
