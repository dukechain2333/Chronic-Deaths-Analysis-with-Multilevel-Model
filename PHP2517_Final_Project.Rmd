...
Moreover, we plot histograms of all numeric variables. Notice that our outcome variable is heavily right skewed, suggesting that we should opt for a poisson model instead of normal.
